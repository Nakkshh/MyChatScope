...
if file:
    ...
    try:
        dayfirst = st.sidebar.radio("Select Date Format in text file:",('dd-mm-yy'))
        ...
        if st.sidebar.button("Show Analysis"):
            ...
            fig, ax = plt.subplots()
            ax.barh(commonWord[0], commonWord[1])  # Use barh for horizontal bar chart
            ax.set_ylabel("Words")  # Set y-axis label
            ax.set_xlabel("Frequency")  # Set x-axis label
            plt.xticks(rotation='horizontal')  # Rotate x-axis labels if needed
